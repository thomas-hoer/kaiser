...
Procedure.s Load_Game(Filename.s = "")
  ...
  If Filename.s
    ...
    If readfile
      ...
      Else
        crc=ReadLong(readfile)
        ReadData(readfile,mem1,Lof(readfile)-8)
        If UnpackMemory(mem1,mem2)
          If CRC32Fingerprint(mem2,10*#spieler_size+#spiel_size)=crc
            For x=0 To 9
...
Procedure.s Save_Game(Filename.s = "")
  ...
  If Filename
    ...
    crc=CRC32Fingerprint(mem1,10*#spieler_size+#spiel_size)
    CreateFile(0,Filename)
      WriteLong(0,#Kaiser_Version)
      WriteLong(0,crc)
      len=PackMemory(mem1,mem2,10*#spieler_size+#spiel_size,9)
...
Frame3DGadget(-1,10,10,90,260,"Verkauf")
...
Frame3DGadget(-1,350,10,90,260,"Verkauf")
...
Frame3DGadget(-1,210,150,130,45,"")
...
Frame3DGadget(-1,110,205,230,40,"Kornzuteilung an die Bevölkerung")
...
Frame3DGadget(-1,10,10,90,220,"Verkauf")
...
Frame3DGadget(-1,280,10,90,220,"Ankauf")
...
mem=spieler(spieler)
;;CreateGadgetList(WindowID(window))
Frame3DGadget(-1,20,20,130,100,"Marktplatz")
...
Frame3DGadget(-1,160,20,130,100,"Kornmühle")
...
Frame3DGadget(-1,300,20,130,100,"Kornspeicher")
...
Frame3DGadget(-1,20,140,130,100,"Palast (Teil)")
...
Frame3DGadget(-1,160,140,130,100,"Kathedrale (Teil)")
...
Frame3DGadget(-1,300,140,130,100,"Lagerhalle")
...
Frame3DGadget(-1,20,250,410,50,"Kapital")
