...
Procedure Window_Kornverteilen(spieler)
  ...
  mem=spieler(spieler)
  FrameGadget(#PB_Any,10,10,90,260,"Verkauf")
  b11=ButtonGadget(#PB_Any,20, 30,70,30,"-100000")
  b12=ButtonGadget(#PB_Any,20, 70,70,30,"-10000")
  b13=ButtonGadget(#PB_Any,20,110,70,30,"-1000")
  b14=ButtonGadget(#PB_Any,20,150,70,30,"-100")
  ;b15=ButtonGadget(#PB_Any,20,190,70,30,">benötigt")
  ;b16=ButtonGadget(#PB_Any,20,230,70,30,">maximum")
  FrameGadget(#PB_Any,350,10,90,260,"Verkauf")
  b21=ButtonGadget(#PB_Any,360, 30,70,30,"+100000")
  b22=ButtonGadget(#PB_Any,360, 70,70,30,"+10000")
  b23=ButtonGadget(#PB_Any,360,110,70,30,"+1000")
  b24=ButtonGadget(#PB_Any,360,150,70,30,"+100")
  ;b25=ButtonGadget(#PB_Any,360,190,70,30,">benötigt")
  ;b26=ButtonGadget(#PB_Any,360,230,70,30,">maximum")
  FrameGadget(#PB_Any,210,10,130,60,"")
  TextGadget(#PB_Any,220,20,60,15,"Einwohner:")
  TextGadget(#PB_Any,220,35,60,15,"Kapazität:")
  TextGadget(#PB_Any,220,50,60,15,"Kornmenge:")
  TextGadget(#PB_Any,280,20,50,15,Str(PeekL(mem+17)),#PB_Text_Right)
  TextGadget(#PB_Any,280,35,50,15,Str(PeekL(mem+80)),#PB_Text_Right)
  kornmenge=TextGadget(#PB_Any,280,50,50,15,Str(PeekL(mem+29)),#PB_Text_Right)
  
  FrameGadget(#PB_Any,210,70,130,80,"")
  b31=ButtonGadget(#PB_Any,220,085,60,15,"Minimum")
  b32=ButtonGadget(#PB_Any,220,105,60,15,"Benötigt")
  b33=ButtonGadget(#PB_Any,220,125,60,15,"Maximum")
  TextGadget(#PB_Any,280,085,50,15,Str(PeekL(mem+17)*0.5),#PB_Text_Right)
  TextGadget(#PB_Any,280,105,50,15,Str(PeekL(mem+17)*5),#PB_Text_Right)
  TextGadget(#PB_Any,280,125,50,15,Str(PeekL(mem+17)*5.3),#PB_Text_Right)
  
  FrameGadget(#PB_Any,210,150,130,45,"")
  TextGadget(#PB_Any,220,160,60,15,"Taler:")
  TextGadget(#PB_Any,220,175,70,15,"Preis a gros")
  taler=TextGadget(#PB_Any,280,160,50,15,Str(PeekL(mem+25)),#PB_Text_Right)
  TextGadget(#PB_Any,290,175,40,15,Str(PeekB(mem+37)),#PB_Text_Right)
  
  FrameGadget(#PB_Any,110,205,230,40,"Kornzuteilung an die Bevölkerung")
  track=TrackBarGadget(#PB_Any,120,220,150,20,PeekL(mem+17)*0.5,PeekL(mem+17)*5.3)
  zuteilung=TextGadget(#PB_Any,280,220,50,15,Str(PeekL(mem+131)),#PB_Text_Right)
  SetGadgetState(track,PeekL(mem+131))
  
  kornverteilung = CanvasGadget(#PB_Any,110,20,89,178)
  If PeekL(mem+17)
  ...
  button=ButtonGadget(#PB_Any,210,250,130,20,"Fertig")
  If PeekL(mem+17)
    fill=PeekL(mem+29)*178/(PeekL(mem+17)*5)
  Else
    fill=Random(178)
...
Procedure Window_Landkauf(spieler)
  ...
  FrameGadget(#PB_Any,10,10,90,220,"Verkauf")
  b11=ButtonGadget(#PB_Any,20, 30,70,30,"-10000")
  b12=ButtonGadget(#PB_Any,20, 70,70,30,"-1000")
  b13=ButtonGadget(#PB_Any,20,110,70,30,"-100")
  b14=ButtonGadget(#PB_Any,20,150,70,30,"-10")
  b15=ButtonGadget(#PB_Any,20,190,70,30,"-1")
  FrameGadget(#PB_Any,280,10,90,220,"Ankauf")
  b21=ButtonGadget(#PB_Any,290, 30,70,30,"+10000")
  b22=ButtonGadget(#PB_Any,290, 70,70,30,"+1000")
  b23=ButtonGadget(#PB_Any,290,110,70,30,"+100")
  b24=ButtonGadget(#PB_Any,290,150,70,30,"+10")
  b25=ButtonGadget(#PB_Any,290,190,70,30,"+1")
  FrameGadget(#PB_Any,110,60,160,90,"")
  TextGadget(#PB_Any,120, 70,80,20,"Taler:")
  TextGadget(#PB_Any,120, 90,80,20,"Land ha:")
  TextGadget(#PB_Any,120,110,80,20,"verfügbar:")
  TextGadget(#PB_Any,120,130,80,20,"Preis a 10ha:")
  taler=     TextGadget(#PB_Any,200, 70,60,20,Str(PeekL(mem+25)),#PB_Text_Right)
  land=      TextGadget(#PB_Any,200, 90,60,20,Str(PeekL(mem+21)),#PB_Text_Right)
  verfuegbar=TextGadget(#PB_Any,200,110,60,20,Str(PeekL(spiel+4)),#PB_Text_Right)
  TextGadget(#PB_Any,200,130,60,20,Str(PeekB(mem+36)),#PB_Text_Right)
  button=ButtonGadget(#PB_Any,140,190,100,30,"Fertig")
  ImageGadget(#PB_Any,110,20,32,32,ImageID(icon(13)))
  ImageGadget(#PB_Any,142,20,32,32,ImageID(icon(13)))
  ImageGadget(#PB_Any,174,20,32,32,ImageID(icon(13)))
  ImageGadget(#PB_Any,206,20,32,32,ImageID(icon(13)))
  ImageGadget(#PB_Any,238,20,32,32,ImageID(icon(13)))
  Repeat
    Event=WaitWindowEvent(#TimeOut)
    EventMenu=EventMenu()
    EventGadget=EventGadget()
...
Procedure Window_Bauwerke(spieler)
  ...
  mem=spieler(spieler)
  FrameGadget(#PB_Any,20,20,130,100,"Marktplatz")
  TextGadget(#PB_Any,70,40,60,20,"1000 Taler")
  TextGadget(#PB_Any,70,60,40,20,"Besitz:")
  markt=TextGadget(#PB_Any,110,60,30,20,Str(PeekW(mem+46)),#PB_Text_Right)
  markt2=ButtonGadget(#PB_Any,30,80,110,30,"Kauf mich!")
  
  FrameGadget(#PB_Any,160,20,130,100,"Kornmühle")
  TextGadget(#PB_Any,210,40,60,20,"2000 Taler")
  TextGadget(#PB_Any,210,60,40,20,"Besitz:")
  muehle=TextGadget(#PB_Any,250,60,30,20,Str(PeekW(mem+48)),#PB_Text_Right)
  muehle2=ButtonGadget(#PB_Any,170,80,110,30,"Kauf mich!")
  
  FrameGadget(#PB_Any,300,20,130,100,"Kornspeicher")
  TextGadget(#PB_Any,350,40,60,20,"2500 Taler")
  TextGadget(#PB_Any,350,60,40,20,"Besitz:")
  speicher=TextGadget(#PB_Any,390,60,30,20,Str(PeekW(mem+50)),#PB_Text_Right)
  speicher2=ButtonGadget(#PB_Any,310,80,110,30,"Kauf mich!")
  
  FrameGadget(#PB_Any,20,140,130,100,"Palast (Teil)")
  TextGadget(#PB_Any,70,160,60,20,"5000 Taler")
  TextGadget(#PB_Any,70,180,40,20,"Besitz:")
  palast=TextGadget(#PB_Any,110,180,30,20,Str(PeekB(mem+54)),#PB_Text_Right)
  palast2=ButtonGadget(#PB_Any,30,200,110,30,"Kauf mich!")
  
  FrameGadget(#PB_Any,160,140,130,100,"Kathedrale (Teil)")
  TextGadget(#PB_Any,210,160,60,20,"9000 Taler")
  TextGadget(#PB_Any,210,180,40,20,"Besitz:")
  kathedrale=TextGadget(#PB_Any,250,180,30,20,Str(PeekB(mem+55)),#PB_Text_Right)
  kathedrale2=ButtonGadget(#PB_Any,170,200,110,30,"Kauf mich!")
  
  FrameGadget(#PB_Any,300,140,130,100,"Lagerhalle")
  TextGadget(#PB_Any,350,160,60,20,"4000 Taler")
  TextGadget(#PB_Any,350,180,40,20,"Besitz:")
  lager=TextGadget(#PB_Any,390,180,30,20,Str(PeekW(mem+52)),#PB_Text_Right)
  lager2=ButtonGadget(#PB_Any,310,200,110,30,"Kauf mich!")
  
  FrameGadget(#PB_Any,20,250,410,50,"Kapital")
  TextGadget(#PB_Any,30,270,60,20,"Taler:")
  taler=TextGadget(#PB_Any,90,270,50,20,Str(PeekL(mem+25)),#PB_Text_Right)
  TextGadget(#PB_Any,150,270,60,20,"Bauland ha:")
  land=TextGadget(#PB_Any,210,270,60,20,Str(PeekL(mem+21)),#PB_Text_Right)
  ImageGadget(#PB_Any, 30, 40,32,32,ImageID(icon(14)))
  ImageGadget(#PB_Any,170, 40,32,32,ImageID(icon(15)))
  ImageGadget(#PB_Any,310, 40,32,32,ImageID(icon(16)))
  ImageGadget(#PB_Any, 30,160,32,32,ImageID(icon(17)))
  ImageGadget(#PB_Any,170,160,32,32,ImageID(icon(18)))
  ImageGadget(#PB_Any,310,160,32,32,ImageID(icon(19)))
  
  button=ButtonGadget(#PB_Any,170,310,110,30,"Fertig")
  Repeat
    Event=WaitWindowEvent(#TimeOut)
    EventMenu=EventMenu()
    EventGadget=EventGadget()
...
Procedure Window_Verkaufen(spieler)
  ...
  mem=spieler(spieler)
  TextGadget(#PB_Any,120,20,60,20,"Preis",#PB_Text_Right)
  TextGadget(#PB_Any,180,20,60,20,"Last",#PB_Text_Right)
  TextGadget(#PB_Any,380,20,60,20,"Verkaufen",#PB_Text_Right)
  
  TextGadget(#PB_Any,60, 60,60,20,"Salz:")
  TextGadget(#PB_Any,60,100,60,20,"Bier:")
  TextGadget(#PB_Any,60,140,60,20,"Wein:")
  TextGadget(#PB_Any,60,180,60,20,"Waffen:")
  
  TextGadget(#PB_Any,120, 60,60,20,Str(PeekW(mem+38)),#PB_Text_Right)
  TextGadget(#PB_Any,120,100,60,20,Str(PeekW(mem+40)),#PB_Text_Right)
  TextGadget(#PB_Any,120,140,60,20,Str(PeekW(mem+42)),#PB_Text_Right)
  TextGadget(#PB_Any,120,180,60,20,Str(PeekW(mem+44)),#PB_Text_Right)
  
  l1=TextGadget(#PB_Any,180, 60,60,20,Str(PeekL(mem+60)),#PB_Text_Right)
  l2=TextGadget(#PB_Any,180,100,60,20,Str(PeekL(mem+64)),#PB_Text_Right)
  l3=TextGadget(#PB_Any,180,140,60,20,Str(PeekL(mem+68)),#PB_Text_Right)
  l4=TextGadget(#PB_Any,180,180,60,20,Str(PeekL(mem+72)),#PB_Text_Right)
  
  t1=TrackBarGadget(#PB_Any,260, 60,100,20,0,PeekL(mem+60))
  t2=TrackBarGadget(#PB_Any,260,100,100,20,0,PeekL(mem+64))
  t3=TrackBarGadget(#PB_Any,260,140,100,20,0,PeekL(mem+68))
  t4=TrackBarGadget(#PB_Any,260,180,100,20,0,PeekL(mem+72))
  
  v1=TextGadget(#PB_Any,380, 60,60,20,"0",#PB_Text_Right)
  v2=TextGadget(#PB_Any,380,100,60,20,"0",#PB_Text_Right)
  v3=TextGadget(#PB_Any,380,140,60,20,"0",#PB_Text_Right)
  v4=TextGadget(#PB_Any,380,180,60,20,"0",#PB_Text_Right)
  
  FrameGadget(#PB_Any,40,220,360,40,"")
  TextGadget(#PB_Any, 50,235,130,20,"Freie Lagerkapazität:")
  lager=TextGadget(#PB_Any,180,235,60,20,Str(PeekL(mem+56)),#PB_Text_Right)
  TextGadget(#PB_Any,260,235,60,20,"Taler:")
  taler=TextGadget(#PB_Any,320,235,60,20,Str(PeekL(mem+25)),#PB_Text_Right)
  button=ButtonGadget(#PB_Any,175,270,100,30,"So soll es sein!")
  
  ImageGadget(#PB_Any,20, 50,32,32,ImageID(icon(20)))
  ImageGadget(#PB_Any,20, 90,32,32,ImageID(icon(21)))
  ImageGadget(#PB_Any,20,130,32,32,ImageID(icon(22)))
  ImageGadget(#PB_Any,20,170,32,32,ImageID(icon(23)))
...
Procedure Window_Steuern(spieler)
  ...
  mem=spieler(spieler)
  TextGadget(#PB_Any,140,10,60,20,"lasch")
  TextGadget(#PB_Any,200,10,60,20,"gierig",#PB_Text_Right)
  TextGadget(#PB_Any,140,140,60,20,"gnädig")
  TextGadget(#PB_Any,200,140,60,20,"brutal",#PB_Text_Right)
  
  TextGadget(#PB_Any,60,40,60,20,"Steuern:")
  TextGadget(#PB_Any,60,80,60,20,"Justiz:")
  TextGadget(#PB_Any,60,120,60,20,"Asylrecht:")
  
  t1=TrackBarGadget(#PB_Any,140,40,120,20,0,100)
  t2=TrackBarGadget(#PB_Any,140,80,120,20,0,100)
  t3=TrackBarGadget(#PB_Any,140,120,120,20,0,100)
  
  a1=TextGadget(#PB_Any,260, 40,40,20,Str(PeekB(mem+76))+" %",#PB_Text_Right)
  a2=TextGadget(#PB_Any,260, 80,40,20,Str(PeekB(mem+77))+" %",#PB_Text_Right)
  a3=TextGadget(#PB_Any,260,120,40,20,Str(PeekB(mem+78))+" %",#PB_Text_Right)
  
  SetGadgetState(t1,PeekB(mem+76))
  SetGadgetState(t2,PeekB(mem+77))
  SetGadgetState(t3,PeekB(mem+78))
  button=ButtonGadget(#PB_Any,115,170,100,30,"Fertig")
  
  ImageGadget(#PB_Any,20, 30,32,32,ImageID(icon(24)))
  ImageGadget(#PB_Any,20, 70,32,32,ImageID(icon(25)))
  ImageGadget(#PB_Any,20,110,32,32,ImageID(icon(26)))
