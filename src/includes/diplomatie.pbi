...
RePaint(EventWindow())
DrawTransparentImage(icon(38),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
;endcase
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(27),WindowOutput(window), 10,10,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(27),WindowOutput(window),258,10,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(24),WindowOutput(window),30, 80,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(13),WindowOutput(window),30,120,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon( 3),WindowOutput(window),30,160,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(24),WindowOutput(window),20,40,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case track
...
Case button
For x=0 To PeekB(spiel)
If name=titel(PeekW(spieler(x)+84),PeekB(spieler(x)+33))+" "+PeekS(spieler(x)+1,16)+" von "+land(PeekB(spieler(x)+124))\name
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(2),WindowOutput(window),20,40,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case track
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(27),WindowOutput(window),134,10,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon( 1),WindowOutput(window),30, 80,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(39),WindowOutput(window),30,120,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(40),WindowOutput(window),30,160,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(41),WindowOutput(window),20,40,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case track
...
RePaint(EventWindow())
DrawTransparentImage(icon(38),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon( 1),WindowOutput(window),10,80,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon( 1),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(38),WindowOutput(window),10,60,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(33),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon( 1),WindowOutput(window),10,10,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(38),WindowOutput(window),10,50,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(38),WindowOutput(window),10,10,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(33),WindowOutput(window),10,50,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(39),WindowOutput(window),10,10,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon( 1),WindowOutput(window),10,50,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(33),WindowOutput(window), 10,10,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(33),WindowOutput(window),258,10,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
DrawTransparentImage(icon(24),WindowOutput(window),30, 80,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(13),WindowOutput(window),30,120,32,32,0,0,32,32,$FF00FF)
DrawTransparentImage(icon(28),WindowOutput(window),30,160,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(28),WindowOutput(window),20,40,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case track
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(33),WindowOutput(window),136,10,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(24),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(2),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
...
Case #PB_Event_Repaint
RePaint(EventWindow())
DrawTransparentImage(icon(28),WindowOutput(window),10,20,32,32,0,0,32,32,$FF00FF)
;endcase
Case #PB_Event_Gadget
Select EventGadget
Case button
